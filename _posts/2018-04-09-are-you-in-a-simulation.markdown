...
If you think this is far fetched consider the history of computer games:  Just over Forty years ago we were playing [pong](https://en.wikipedia.org/wiki/Pong). Today our games are photo-realistic, and we already have more immersive virtual reality technology.

just imagine the quality of games in ten or twenty years time, let along another forty years.  Even if progress levelled or slowed dramatically, we would achieve simulations if there was any rate of progress at all.
...
So that's the essence of the simulation aregument.  Let's now look at the hypothesis as proposed by [Nick Bostrum](https://nickbostrom.com/).
...
In this game show there are three doors.  You are supposed to pick a door and get the prize behind the door.
...
So the idea is similiar in that it is based on probability; There are infinitely more possible simulations than our original base reality (just the one).
...
However, it doesn't seem impossible to recast the simulation theory in a way that makes it a sceptical argument. Nor would this make it any less likely.

## Consequences
If we are in a simulation there are some interesting consequences for ethics, morality and physics among others.

For example, it occurred to me while writing this that time in simulations would be different as it doesn't seem useful to have a simulation run at the same pace as base reality.  At least it would be more useful to have simulations run faster than base reality.
